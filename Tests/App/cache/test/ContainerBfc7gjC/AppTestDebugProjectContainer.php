...
class AppTestDebugProjectContainer extends Container
{
    ...
    public function __construct(array $buildParameters = array(), $containerDir = __DIR__)
    {
        ...
        $this->methodMap = array(
            ...
            'mabe_rate_limit.redis_client' => 'getMabeRateLimit_RedisClientService',
    ...
    /**
     * Gets the public 'mabe_rate_limit.redis_client' shared service.
     *
     * @return \Redis
     */
    protected function getMabeRateLimit_RedisClientService()
    {
        return $this->services['mabe_rate_limit.redis_client'] = \Symfony\Component\Cache\Adapter\RedisAdapter::createConnection('redis://127.0.0.1:6379/5');
    }
    ...
    /**
     * Gets the private 'mabe_rate_limit.listener' shared service.
     *
     * @return \Mabe\RateLimitBundle\EventListener\RateLimitListener
     */
    protected function getMabeRateLimit_ListenerService()
    {
        return $this->privates['mabe_rate_limit.listener'] = new \Mabe\RateLimitBundle\EventListener\RateLimitListener($this->parameters['mabe_rate_limit.paths'], ($this->services['security.token_storage'] ?? $this->services['security.token_storage'] = new \Symfony\Component\Security\Core\Authentication\Token\Storage\TokenStorage()), ($this->services['security.authorization_checker'] ?? $this->getSecurity_AuthorizationCheckerService()), ($this->services['mabe_rate_limit.redis_client'] ?? $this->getMabeRateLimit_RedisClientService()), true);
    }
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = array(
                ...
                'MabeRateLimitBundle' => array(
                    'path' => $this->targetDirs[4],
                    'namespace' => 'Mabe\\RateLimitBundle',
                ),
            ); break;
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'MabeRateLimitBundle' => 'Mabe\\RateLimitBundle\\MabeRateLimitBundle',
            ),
            ...
            'mabe_rate_limit.redis_dsn' => 'redis://127.0.0.1:6379/5',
            'mabe_rate_limit.enabled' => true,
        );
    }
}
